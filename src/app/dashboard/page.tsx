...
const LinkAccountModal = ({ onClose, onLink }: { onClose: () => void, onLink: (platform: string, username: string) => void }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-slate-800 p-6 rounded-lg max-w-md w-full mx-4">
        <h3 className="text-lg font-semibold text-white mb-4">Link Game Account</h3>
        <p className="text-slate-300 mb-6">
          Link your gaming platform account to verify your identity and join tournaments.
        </p>
...
const mockTournaments = [
  {
    ...
    rewards: [
      { position: 1, points: 500, badges: [{ id: 'cs2-champ', name: 'CS2 Champion', description: 'CS2 Winner', icon: '🏆', type: 'tournament' as const, rarity: 'legendary' as const, unlockedAt: new Date() }] }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    teamSize: 5,
    rewards: [
      { position: 1, points: 750, badges: [{ id: 'val-champ', name: 'Valorant Champion', description: 'Valorant Winner', icon: '🏆', type: 'tournament' as const, rarity: 'legendary' as const, unlockedAt: new Date() }] }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    teamSize: 3,
    rewards: [
      { position: 1, points: 1000, badges: [{ id: 'rl-champ', name: 'RL Champion', description: 'Rocket League Winner', icon: '🏆', type: 'tournament' as const, rarity: 'legendary' as const, unlockedAt: new Date() }] }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    ...
    teamSize: 5,
    rewards: [
      { position: 1, points: 600, badges: [{ id: 'lol-champ', name: 'LoL Champion', description: 'League Winner', icon: '🏆', type: 'tournament' as const, rarity: 'legendary' as const, unlockedAt: new Date() }] }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
          ...
          <div className="p-6">
            ...
            <div className="bg-slate-800 rounded-lg p-4 mb-6">
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-gaming-400 font-semibold">{user.totalPoints.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-300 text-sm">Tournaments Won</span>
                  <span className="text-white font-semibold">{user.tournamentsWon}</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="space-y-4 mb-8">
              ...
              >
                ...
                <span>{user.teamId ? 'Manage Team' : 'Create/Join Team'}</span>
              </button>
              ...
              >
                ...
                <span>{user.hasLinkedAccount ? 'Account Linked ✓' : 'Link Game Account'}</span>
              </button>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm text-slate-300 mb-2">Skill Level</label>
                    <select 
                      value={selectedSkill}
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <label htmlFor="private-only" className="text-sm text-slate-300">
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="w-4 h-4 text-gaming-600 bg-slate-800 border-slate-700 rounded focus:ring-gaming-500"
                      />
                      <label htmlFor="team-only" className="text-sm text-slate-300">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-slate-400">
                Compete for points, ranks, and amazing rewards in your favorite games
              </p>
            </div>
