        ...
        <div className="space-y-2">
          <div
            className={`flex items-center justify-between p-2 rounded ${
              isWinner1
                ? 'bg-gaming-600/20 border border-gaming-600'
                : 'bg-slate-700/50'
            }`}
          >
            <div className="flex items-center gap-2">
          ...
          <div className="gaming-card rounded-xl p-6 mb-8">
            ...
            <div className="space-y-4">
              {mockLiveMatches.map((match) => (
                <div
                  key={match.id}
                  className="bg-slate-800/50 rounded-lg p-4 border-2 border-red-500"
                >
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 bg-slate-700 rounded-full h-3">
              <div
                ...
                style={{
                  width: `${
                    (mockTournament.currentRound / mockTournament.totalRounds) *
                    100
                  }%`,
                }}
              ></div>
            ...
            <span className="text-sm text-slate-400">
              Round {mockTournament.currentRound} of{' '}
              {mockTournament.totalRounds}
            </span>
          </div>
        </div>
              ...
              <div className="bg-slate-800 rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white">
                    {selectedMatch.player1?.username || 'TBD'}
                  </span>
                  <span className="text-xl font-bold text-white">
                    {selectedMatch.player1Score || 0}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-white">
                    {selectedMatch.player2?.username || 'TBD'}
                  </span>
                  <span className="text-xl font-bold text-white">
                    {selectedMatch.player2Score || 0}
                  </span>
                </div>
              </div>
